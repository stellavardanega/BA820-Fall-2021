...
afinn.score("Today was a great day!")

# let's try another
afinn.score("Today was a horrible day!")
...
corpus = ['Today is a great day', 'Today is a horrible day']
...
# subjectivity?
nlp("python is the greatest programming language on earth")._.subjectivity
nlp("python is free an open source")._.subjectivity
